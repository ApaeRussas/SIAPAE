...
class MedHistoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'informant' => 'required|string|max:125',
            'date_of_anamnesis' => 'required|min:8',
            'appraisal' => 'required|string|max:125',
            'have_caregiver' => 'required|boolean',
            'have_AEE' => 'required|boolean',
            'turn_AEE' => 'nullable|string|max:125',
            'school' => 'nullable|string|max:125',
            'grade_school' => 'nullable|string|max:125',
            'sige' => 'required|string|max:125',
            'turn_school' => 'nullable|string|max:125',
            'study' => 'nullable|string|max:125',
            'name_mother' => 'required|string',
            'date_mother' => 'required|min:8',
            'rg_mother' => 'required|string|max:125',
            'profession_mother' => 'required|string|max:125',
            'cellphone_mother' => 'nullable|string|max:15',
            'name_father' => 'nullable|string',
            'date_father' => 'nullable|min:8',
            'rg_father' => 'nullable|string|max:125',
            'profession_father' => 'nullable|string|max:125',
            'cellphone_father' => 'nullable|string|max:15',
            'address' => 'required|string|max:125',
            'have_medication' => 'required|boolean',
            'what_medication' => 'nullable|string|max:125',
            // II - Initial complaint
            'compplaint' => 'nullable|string|max:1024',
            // III - Socio-family situation
            'who_lives' => 'required|string|max:125',
            'state_parents_relation' => 'required|string|max:125',
            'time_state_relation' => 'nullable|string|max:125',
            'new_relation_mother' => 'required|boolean',
            'time_new_relation_mother' => 'nullable|string|max:125',
            'lives_together_new_relation_mother' => 'nullable|string|max:125',
            'new_relation_father' => 'required|boolean',
            'time_new_relation_father' => 'nullable|string|max:125',
            'lives_together_new_relation_father' => 'nullable|string|max:125',
            ...
            'other_difficulty' => 'nullable|string|max:1024',
            // VI - Behavioral attitudes
            'child_temperament' => 'required|string|max:125',
            ...
            'how_manifests_inappropriate_behavior' => 'nullable|string|max:125',
            'tics_manias' => 'required|boolean',
            'what_tics_manias' => 'nullable|string|max:125',
            'hyperfocus' => 'required|boolean',
            'how_manifests_hyperfocus' => 'nullable|string|max:125',
            ...
            'how_manifests_sexual_curiosity' => 'nullable|string|max:125',
            'daily_routine' => 'required|boolean',
            'rigidity_daily_routine' => 'nullable|string|max:125',
            'what_daily_routine' => 'nullable|string|max:125',
            'sports_activity' => 'required|boolean',
            'what_sports_activity' => 'nullable|string|max:125',
            // VII - Scholarity
            'age_start_school' => 'required|string|max:125',
            'how_school_adaptation' => 'required|string|max:125',
            'have_difficulty_learning' => 'required|boolean',
            'justify_difficulty_learning' => 'nullable|string|max:125',
            'school_reinforcement' => 'required|string',
            'parents_participate_school_life' => 'required|string',
            'favorite_activity_school' => 'required|string|max:125',
            ...
            'who_recommend_institution' => 'nullable|string|max:125',
            'participate_contribution' => 'required|string',
            // XII - Observações Gerais
            'general_observations' => 'nullable|string|max:1024',

            'signature_id' => 'required|string|max:125',
        ];

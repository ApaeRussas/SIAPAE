...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('med_histories', function (Blueprint $table) {
            ...
            $table->text('name_father')->nullable();
            $table->date('date_father')->nullable();
            $table->string('rg_father')->nullable();
            $table->string('profession_father')->nullable();
            ...
            $table->string('compplaint', 1024)->nullable();
            ...
            $table->string('other_difficulty', 1024)->nullable();
            ...
            $table->string('what_tics_manias')->nullable();
            $table->boolean('hyperfocus');
            $table->string('how_manifests_hyperfocus')->nullable();
            ...
            $table->string('general_observations', 1024)->nullable();

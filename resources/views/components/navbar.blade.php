...
<!-- Mobile bottom bar -->
<div
    class="fixed inset-x-0 bottom-0 flex items-center justify-between px-4 py-3 sm:px-6 transition-transform duration-500 bg-white md:hidden dark:bg-dark-eval-1 z-10"
    :class="{
        'translate-y-full': scrollingDown,
        'translate-y-0': scrollingUp,
    }"
>
    ...
    <a href="{{ route('dashboard') }}">
        ...
        <x-application-logo-dark x-show="isDarkMode" class="w-24" />

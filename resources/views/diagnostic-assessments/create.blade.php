                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="date"
                                    name="date"
                                    value="{{ old('date', $date ?: now()->format('d/m/Y')) }}"
                                ...
                                <div class="space-y-3">
                                    ...
                                    <label class="assessment-check">
                                        ...
                                        <input
                                            ...
                                            value="1"
                                            {{ old('language.simple_text') ? 'checked' : '' }}
                                        >
                                    ...
                                    <label class="assessment-check">
                                        ...
                                        <input
                                            ...
                                            value="1"
                                            {{ old('language.simple_text_interprets') ? 'checked' : '' }}
                                        >
                                ...
                                <div class="space-y-3">
                                    ...
                                    <label class="assessment-check">
                                        ...
                                        <input
                                            ...
                                            value="1"
                                            {{ old('language.paragraph_text') ? 'checked' : '' }}
                                        >
                                    ...
                                    <label class="assessment-check">
                                        ...
                                        <input
                                            ...
                                            value="1"
                                            {{ old('language.paragraph_text_interprets') ? 'checked' : '' }}
                                        >
                            ...
                            @foreach ($mathItems as $key => $label)
                                ...
                                <label class="assessment-check">
                                    ...
                                    <input
                                        ...
                                        value="1"
                                        {{ old("logical_mathematical.$key") ? 'checked' : '' }}
                                    >
                                ...
                                @foreach ([
                                    ...
                                    <label class="assessment-check">
                                        ...
                                        <input
                                            ...
                                            value="1"
                                            {{ old("logical_mathematical.geometric_shapes.$key") ? 'checked' : '' }}
                                        >
                                ...
                                @foreach ([
                                    ...
                                    <label class="assessment-check">
                                        ...
                                        <input
                                            ...
                                            value="1"
                                            {{ old("logical_mathematical.operations.$key") ? 'checked' : '' }}
                                        >
                                            ...
                                            @foreach ($options as $option)
                                                ...
                                                <label class="assessment-radio">
                                                    ...
                                                    <input
                                                        ...
                                                        value="{{ $option }}"
                                                        {{ old("logical_mathematical.spatial_knowledge.$key") === $option ? 'checked' : '' }}
                                                    >
                            ...
                            @foreach ([
                                ...
                                <label class="assessment-check">
                                    ...
                                    <input
                                        ...
                                        value="1"
                                        {{ old("functional_life.$key") ? 'checked' : '' }}
                                    >
                    ...
                    <section class="mb-8">
                        ...
                        <label class="assessment-check mb-5">
                            ...
                            <input
                                ...
                                value="1"
                                {{ old('body_experience.body_parts') ? 'checked' : '' }}
                            >
                        ...
                        <label class="assessment-check mb-6">
                            ...
                            <input
                                ...
                                value="1"
                                {{ old('body_experience.right_left') ? 'checked' : '' }}
                            >
                                ...
                                @foreach ([
                                    ...
                                    <label class="assessment-radio">
                                        ...
                                        <input
                                            ...
                                            value="{{ $key }}"
                                            {{ old('body_experience.drawing_phase') === $key ? 'checked' : '' }}
                                        >
                    ...
                    <section class="mb-8">
                        ...
                        <label class="assessment-check mb-5">
                            ...
                            <input
                                ...
                                value="1"
                                {{ old('nature_society.traffic_light_colors') ? 'checked' : '' }}
                            >

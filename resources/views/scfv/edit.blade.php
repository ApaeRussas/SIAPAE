...
2- Avaliação dos grupos ..." required height="lg">
        ...
        <div class="mb-4 mt-3 grid grid-cols-1 sm:grid-cols-4 gap-x-4 gap-y-3">
            <div class="cols-span-1 sm:col-span-3">
                ...
                <x-form.input id="1Q_place" type="text" name="1Q_place" value="{{ old('1Q_place',  data_get($scfv, '1Q_place')) }}"
            ...
            <div class="col-span-1">
                ...
                <x-form.input id="1Q_date" type="text" name="1Q_date" autocomplete="off" value="{{ old('1Q_date', data_get($scfv, '1Q_date')) }}"
        ...
        <div class="mb-3 mt-3 grid grid-cols-1 sm:grid-cols-4 gap-x-4 gap-y-3">
            <div class="col-span-1 sm:col-span-3">
                ...
                <x-form.input id="2Q_place" type="text" name="2Q_place" value="{{ old('2Q_place', data_get($scfv, '2Q_place'))}}"
                    class="w-full dark:text-gray-400" placeholder="Ex: Sede da Apae Russas" required />
            ...
            <div class="col-span-1">
                ...
                <x-form.input id="2Q_date" type="text" name="2Q_date" autocomplete="off" value="{{ old('2Q_date', data_get($scfv, '2Q_date')) }}"
                    class="w-full dark:text-gray-400 date dateInput" x-init="initFlatpickr" placeholder="Ex: 01/11/2001"
                    required />
            ...
            <div class="col-span-1 sm:col-span-3">
                ...
                <x-form.select idSelect="signature_id" valueName="signature_id" full>
                    ...
                    @foreach ($professors as $professor)
                        <option value="{{ $professor->id }}" {{ old('signature_id', $scfv->signature_id ) == $professor->id ? 'selected' : '' }}>
                            {{ $professor->name }}
                        </option>
                    @endforeach
                </x-form.select> 

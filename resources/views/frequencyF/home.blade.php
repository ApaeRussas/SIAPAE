        ...
        <div class="flex flex-col md:justify-between max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mb-3">
            <div class="flex items-center gap-x-1">
                ...
                <x-button
                    button
                    variant="question"
                    class="mt-1 sm:mt-2 !bg-transparent !border-0 !text-[#2F7658] shadow-none"
                    size="sm"
                    ...
                    >
                        ...
                        <div class="flex grid sm:grid-cols-2 gap-y-3">
                            ...
                            <div class="sm:ml-auto sm:self-end">
                                ...
                                <x-button class="!bg-[#3B7D5A] hover:!bg-[#2F684A] !border-[#3B7D5A]">
...
<style>
    /* =========================================================
       LISTA DE FREQUÊNCIA
       MESMO PADRÃO VISUAL DA PÁGINA DE FICHA DOS ESTUDANTES
       ========================================================= */
    ...
    /* Botões principais (Filtrar, Atualizar) -> verde
       (exclui os botões de presença/falta, que já têm cor própria) */
    .frequency-list-page button:not(.btn-toggle),
    .frequency-list-page .bg-blue-500,
    .frequency-list-page .bg-blue-600,
    .frequency-list-page .bg-blue-700 {
    ...
    .frequency-list-page button:not(.btn-toggle):hover,
    .frequency-list-page .bg-blue-500:hover,
    .frequency-list-page .bg-blue-600:hover,
    .frequency-list-page .bg-blue-700:hover {
        background-color: var(--siapae-green-dark) !important;
        border-color: var(--siapae-green-dark) !important;
        color: #ffffff !important;
    }
 
    /* Textos/ícones azuis remanescentes -> verde */
    .frequency-list-page .text-blue-500,
    .frequency-list-page .text-blue-600,
    .frequency-list-page .text-blue-700 {
        color: var(--siapae-green) !important;
    }
 
    /* Foco dos campos de busca (turno, mês/ano, professor) */
    .frequency-list-page select:focus,
    .frequency-list-page input:focus {
        border-color: var(--siapae-green) !important;
